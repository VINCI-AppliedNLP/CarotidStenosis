...
//Sectionizer is primarily used for stenosis guidelines and criteria, utilizing all sections for now anyways
    ...
    "stenosis_guidelines" {
        expressions = [
                'Criteria(:|-)',
                'Definitions(:|-)',
                'Grades\\s*of\\s*stenosis(:|-)',
                'CAROTID\\s*STENOSIS\\s*REFERENCE(:|-)',
                'Criteria\\s*for\\s*Diagnosis\\s*of\\s*ICA\\s*Stenosis(:|-)',
                'Ultrasound\\s*Criteria\\s*for\\s*Diagnosis(:|-)',
                'Society\\s*of\\s*radiologists\\s*in\\s*ultrasound\\s*\\(SRU\\)\\s*consensus(:|-)',
                'Doppler\\s*criteria\\s*for\\s*determining',
                'Carotid\\s*Stent\\s*Stenosis\\s*Criteria',
                'Criteria\\s*for\\s*in\\-stent\\s*internal\\s*carotid\\s*artery\\s*stenoses',
                'Consensus\\s*Panel\\s*Gray\\-Scale\\s*and\\s*Doppler\\s*US\\s*Criteria\\s*for\\s*Diagnosis\\s*of\\s*ICA\\s*Stenosis',

                //'Gray-Scale and Doppler US Criteria for Diagnosis'

        ]
        concept_feature_value = "stenosis_guideline"
        outputType = "gov.va.vinci.types.SectionHeader"
    }

    "stenosis_laterality_right" {
        expressions = [
                'right:',
                'right\\s*side:',
                '       RIGHT\n',
                ...
                'right\\s*carotid:',
                'right\\s*carotid\\b',
                'right\\s*carotid\\s*artery:',
                'RIGHT\\s*CAROTID\\s*SYSTEM:'
        ]
        concept_feature_value = "stenosis_laterality_right"
        outputType = "gov.va.vinci.types.SectionHeader"
    }
    "stenosis_laterality_left" {
        expressions = [
                'left:',
                'left\\s*side:',
                '       LEFT\n',
                ...
                'left\\s*carotid:',
                'left\\s*carotid\\b',
                'left\\s*carotid\\s*artery:',
                'Left\\s*CAROTID\\s*SYSTEM:'
        ]
        concept_feature_value = "stenosis_laterality_left"
        outputType = "gov.va.vinci.types.SectionHeader"
    }

    "stenosis_guideline" {
        expressions = [
                'Sonographic\\s*NASCET\\s*Index:'
        ]
        concept_feature_value = "stenosis_guideline"
        outputType = "gov.va.vinci.types.SectionHeader"
    }
    ...
    "radiology_findings" {
        ...
        concept_feature_value = "radiology_findings"
        outputType = "gov.va.vinci.types.SectionHeader"
    }

    "radiology_conclusion" {
        expressions = [
                '\\r(\\n)? *conclusion *(:|-)',


        ]
        concept_feature_value = "radiology_conclusion"
        outputType = "gov.va.vinci.types.SectionHeader"
    }
    ...
    "radiology_comparison" {
        ...
        concept_feature_value = "radiology_comparison"
        outputType = "gov.va.vinci.types.SectionHeader"
    }
    ...
    "radiology_method" {
        ...
        concept_feature_value = "radiology_method"
        outputType = "gov.va.vinci.types.SectionHeader"
    }
